    ...
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        <div
          title="Github"
          onClick={() =>
            window.open("https://github.com/farhod-07", "_blank")
          }
        >
        ...
        <div
          title="Instagram"
          onClick={() =>
            window.open("https://www.instagram.com/pgc_royal/", "_blank")
          }
        >
          {" "}
        ...
        <div
          title="Facebook"
          onClick={() =>
            window.open("https://www.facebook.com/farhod.tojiyev.509")
          }
        >
